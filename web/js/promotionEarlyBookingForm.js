$(document).ready(function () {
    ...
    var $container2 = $('div#kvartiri_kvartiribundle_promotions_promotionEarlyBooking');

    // On ajoute un lien pour ajouter une nouvelle catégorie
    var $lienAjout2 = $('<a href="#" id="ajout_adresse" class="btn btn-info">Add an promotion</a>');
    ...
    $lienAjout2.click(function (e) {
        if (index <= 9) {
            ...
            var $lienlimit2 = $('<h1 class="btn btn-info">You are entitled to 10 promotions</h1>');
    ...
    function ajouterAdresse2($container2) {
        ...
        var $prototype2 = $($container2.attr('data-prototype').replace(/__name__label__/g, 'Promotion n°' + (index + 1))
    ...
    function ajouterLienSuppression2($prototype2, index) {
        // Création du lien
        $lienSuppression2 = $('<a href="#" class="btn btn-danger">Delete Promotion</a>');
