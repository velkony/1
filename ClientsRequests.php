...
class ClientsRequests
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Users\UsersBundle\Entity\RoomsRequests", inversedBy="clientRequest")
     * @ORM\JoinTable(name="clients_requests_rooms",
     *      joinColumns={@ORM\JoinColumn(name="clients_requests_id", referencedColumnName="id")},
     *      inverseJoinColumns={@ORM\JoinColumn(name="rooms_requests_id", referencedColumnName="id")}
     *      )
     */
...
//    }
    ...
    public function addRoomsRequest(\Users\UsersBundle\Entity\RoomsRequests $roomsRequests)
    {
        ...
        $roomsRequests->addClientRequest($this);
